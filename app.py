...
def generate():
    ...
    return f"<h2>Avatars generated!</h2>" \
           f"<p>/download/{ultimate_title.replace(Download Ultimate Avatar</a></p>" \
           f"<p>/download/{worst_title.replace(Download Worst Avatar</a></p>"
